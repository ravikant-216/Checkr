...
public class UserAdvice {
    ...
    private ResponseEntity<ErrorResponse>  userNotFound(UserNotFound userNotFound){
        ErrorResponse errorResponse= ErrorResponse.builder().title(HttpStatus.NOT_FOUND.getReasonPhrase()).time(System.currentTimeMillis()).message(userNotFound.getMessage()).build();
